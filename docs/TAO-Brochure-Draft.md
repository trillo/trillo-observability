...
- **OliverDB performance** — fleet-scale telemetry at very high speed.
...
*(Trillo AI Observability architecture diagram — full width, kept large and readable.)*
...
- **Higher SRE productivity** — ~25% boost, investigating incidents conversationally from Claude Code (MCP).
